                ...
                <form id="originalform" enctype="multipart/form-data">
                    ...
                    <div class="{{ $data->inputtype == 'checkbox' ? 'form-check' : 'form-floating' }} mb-3 ">
                        <input type="{{ $data->inputtype }}"
                            ...
                            id="{{ $data->value }}" name="{{ $data->value }}" data-inputs="{{ $data->inputtype }}"
                    ...
                    <div class="mb-3 text-start">
                        ...
                        <input class="form-control form-control-lg" data-inputs="{{ $data->inputtype }}"
                            name="{{ $data->value }}" id="{{ $data->value }}" type="file" onchange="previewFile(event)"
                    ...
                    <div class="form-floating mb-3">
                        <textarea class="form-control" data-inputs="{{ $data->inputtype }}"
                            placeholder="Enter your address" id="{{ $data->value }}" name="{{ $data->value }}"
