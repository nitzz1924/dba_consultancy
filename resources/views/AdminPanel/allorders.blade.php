                        ...
                        <div class="col-md-5 ">
                            ...
                            <div class="">
                                <div class="btn-group mt-2" role="group" aria-label="Basic example">
                                    <a href="{{ route('customersallorders') }}"
                                        class="btn {{ request()->routeIs('customersallorders') ? 'btn-dark' : 'btn-light' }}">All</a>
                                    <a href="{{ route('customersorders', ['status' => 'Hold']) }}"
                                        class="btn {{ request()->route('status') == 'Hold' ? 'btn-dark' : 'btn-light' }}">On
                                        Hold</a>
                                    <a href="{{ route('customersorders', ['status' => 'Processing']) }}"
                                        class="btn {{ request()->route('status') == 'Processing' ? 'btn-dark' : 'btn-light' }}">Processing</a>
                                    <a href="{{ route('customersorders', ['status' => 'Cancel']) }}"
                                        class="btn {{ request()->route('status') == 'Cancel' ? 'btn-dark' : 'btn-light' }}">Cancelled</a>
                                    <a href="{{ route('customersorders', ['status' => 'Completed']) }}"
                                        class="btn {{ request()->route('status') == 'Completed' ? 'btn-dark' : 'btn-light' }}">Completed</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                @if($data->status == 'Hold')
                                                    <span class="badge badge-label bg-secondary fs-6"><i
                                                            class="mdi mdi-circle-medium"></i> On Hold</span>
